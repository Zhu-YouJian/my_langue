...
Token lexer_next(Lexer* lexer) {
    ...
    if (str_eq(ident, "fn")) {
    return (Token)((Token){ .kind = 4, .span = span, .ival = 4, .sval = "" });
    }
    if (str_eq(ident, "let")) {
    return (Token)((Token){ .kind = 5, .span = span, .ival = 5, .sval = "" });
    }
    if (str_eq(ident, "mut")) {
    return (Token)((Token){ .kind = 6, .span = span, .ival = 6, .sval = "" });
    }
    if (str_eq(ident, "if")) {
    return (Token)((Token){ .kind = 7, .span = span, .ival = 7, .sval = "" });
    }
    if (str_eq(ident, "else")) {
    return (Token)((Token){ .kind = 8, .span = span, .ival = 8, .sval = "" });
    }
    if (str_eq(ident, "match")) {
    return (Token)((Token){ .kind = 9, .span = span, .ival = 9, .sval = "" });
    }
    if (str_eq(ident, "return")) {
    return (Token)((Token){ .kind = 10, .span = span, .ival = 10, .sval = "" });
    }
    if (str_eq(ident, "struct")) {
    return (Token)((Token){ .kind = 16, .span = span, .ival = 16, .sval = "" });
    }
    if (str_eq(ident, "fn")) {
    return (Token)((Token){ .kind = 4, .span = span, .ival = 4, .sval = "" });
    }
    if (str_eq(ident, "while")) {
    return (Token)((Token){ .kind = 11, .span = span, .ival = 11, .sval = "" });
    }
    if (str_eq(ident, "for")) {
    return (Token)((Token){ .kind = 12, .span = span, .ival = 12, .sval = "" });
    }
    if (str_eq(ident, "loop")) {
    return (Token)((Token){ .kind = 13, .span = span, .ival = 13, .sval = "" });
    }
    if (str_eq(ident, "break")) {
    return (Token)((Token){ .kind = 14, .span = span, .ival = 14, .sval = "" });
    }
    if (str_eq(ident, "continue")) {
    return (Token)((Token){ .kind = 15, .span = span, .ival = 15, .sval = "" });
    }
    if (str_eq(ident, "struct")) {
    return (Token)((Token){ .kind = 16, .span = span, .ival = 16, .sval = "" });
    }
    if (str_eq(ident, "enum")) {
    return (Token)((Token){ .kind = 17, .span = span, .ival = 17, .sval = "" });
    }
    if (str_eq(ident, "impl")) {
    return (Token)((Token){ .kind = 18, .span = span, .ival = 18, .sval = "" });
    }
    if (str_eq(ident, "trait")) {
    return (Token)((Token){ .kind = 19, .span = span, .ival = 19, .sval = "" });
    }
    if (str_eq(ident, "use")) {
    return (Token)((Token){ .kind = 20, .span = span, .ival = 20, .sval = "" });
    }
    if (str_eq(ident, "mod")) {
    return (Token)((Token){ .kind = 21, .span = span, .ival = 21, .sval = "" });
    }
    if (str_eq(ident, "true")) {
    return (Token)((Token){ .kind = 22, .span = span, .ival = 22, .sval = "" });
    }
    if (str_eq(ident, "false")) {
    return (Token)((Token){ .kind = 23, .span = span, .ival = 23, .sval = "" });
    }
    if (str_eq(ident, "move")) {
    return (Token)((Token){ .kind = 24, .span = span, .ival = 24, .sval = "" });
    }
    if (str_eq(ident, "self")) {
    return (Token)((Token){ .kind = 25, .span = span, .ival = 25, .sval = "" });
    }
...
const char* cgen_stmt(Program* prog, void* exprs, void* stmts, int64_t idx) {
    ...
    return (const char*)str_add(str_add(str_add(str_add("int ", ((EnumVariant*)s)->name), " = "), init), ";\n");
    }
...
const char* cgen_struct(StructDef* s) {
    ...
    out = str_add(str_add(str_add(out, "    int "), ((EnumVariant*)f)->name), ";\n");
    i = (i + 1);
    0;
    }
