...
Token lexer_next(Lexer* lexer) {
    ...
    if (str_eq(ch, "")) {
    return (Token)((Token){ .kind = 61, .span = span, .disc = 61, .ival = 0, .sval = "" });
    }
    if (is_digit(ch)) {
    ...
    if (is_float) {
    return (Token)((Token){ .kind = 1, .span = span, .disc = 1, .ival = 0, .sval = int_part });
    }
    /* Let iv declared=Base(I64) val_ty=Base(I64) */
    int64_t iv = parse_int(int_part);
    return (Token)((Token){ .kind = 0, .span = span, .disc = 0, .ival = iv, .sval = "" });
    }
    if (is_alpha(ch)) {
    ...
    if (str_eq(ident, "fn")) {
    return (Token)((Token){ .kind = 4, .span = span, .disc = 4, .ival = 0, .sval = "" });
    }
    if (str_eq(ident, "let")) {
    return (Token)((Token){ .kind = 5, .span = span, .disc = 5, .ival = 0, .sval = "" });
    }
    if (str_eq(ident, "mut")) {
    return (Token)((Token){ .kind = 6, .span = span, .disc = 6, .ival = 0, .sval = "" });
    }
    if (str_eq(ident, "if")) {
    return (Token)((Token){ .kind = 7, .span = span, .disc = 7, .ival = 0, .sval = "" });
    }
    if (str_eq(ident, "else")) {
    return (Token)((Token){ .kind = 8, .span = span, .disc = 8, .ival = 0, .sval = "" });
    }
    if (str_eq(ident, "match")) {
    return (Token)((Token){ .kind = 9, .span = span, .disc = 9, .ival = 0, .sval = "" });
    }
    if (str_eq(ident, "return")) {
    return (Token)((Token){ .kind = 10, .span = span, .disc = 10, .ival = 0, .sval = "" });
    }
    if (str_eq(ident, "struct")) {
    return (Token)((Token){ .kind = 16, .span = span, .disc = 16, .ival = 0, .sval = "" });
    }
    if (str_eq(ident, "fn")) {
    return (Token)((Token){ .kind = 4, .span = span, .disc = 4, .ival = 0, .sval = "" });
    }
    if (str_eq(ident, "while")) {
    return (Token)((Token){ .kind = 11, .span = span, .disc = 11, .ival = 0, .sval = "" });
    }
    if (str_eq(ident, "for")) {
    return (Token)((Token){ .kind = 12, .span = span, .disc = 12, .ival = 0, .sval = "" });
    }
    if (str_eq(ident, "loop")) {
    return (Token)((Token){ .kind = 13, .span = span, .disc = 13, .ival = 0, .sval = "" });
    }
    if (str_eq(ident, "break")) {
    return (Token)((Token){ .kind = 14, .span = span, .disc = 14, .ival = 0, .sval = "" });
    }
    if (str_eq(ident, "continue")) {
    return (Token)((Token){ .kind = 15, .span = span, .disc = 15, .ival = 0, .sval = "" });
    }
    if (str_eq(ident, "struct")) {
    return (Token)((Token){ .kind = 16, .span = span, .disc = 16, .ival = 0, .sval = "" });
    }
    if (str_eq(ident, "enum")) {
    return (Token)((Token){ .kind = 17, .span = span, .disc = 17, .ival = 0, .sval = "" });
    }
    if (str_eq(ident, "impl")) {
    return (Token)((Token){ .kind = 18, .span = span, .disc = 18, .ival = 0, .sval = "" });
    }
    if (str_eq(ident, "trait")) {
    return (Token)((Token){ .kind = 19, .span = span, .disc = 19, .ival = 0, .sval = "" });
    }
    if (str_eq(ident, "use")) {
    return (Token)((Token){ .kind = 20, .span = span, .disc = 20, .ival = 0, .sval = "" });
    }
    if (str_eq(ident, "mod")) {
    return (Token)((Token){ .kind = 21, .span = span, .disc = 21, .ival = 0, .sval = "" });
    }
    if (str_eq(ident, "true")) {
    return (Token)((Token){ .kind = 22, .span = span, .disc = 22, .ival = 0, .sval = "" });
    }
    if (str_eq(ident, "false")) {
    return (Token)((Token){ .kind = 23, .span = span, .disc = 23, .ival = 0, .sval = "" });
    }
    if (str_eq(ident, "move")) {
    return (Token)((Token){ .kind = 24, .span = span, .disc = 24, .ival = 0, .sval = "" });
    }
    if (str_eq(ident, "self")) {
    return (Token)((Token){ .kind = 25, .span = span, .disc = 25, .ival = 0, .sval = "" });
    }
    return (Token)((Token){ .kind = 3, .span = span, .disc = 3, .ival = 0, .sval = ident });
    }
    if (str_eq(ch, "\"")) {
    lexer_advance(lexer);
    ...
    return (Token)((Token){ .kind = 2, .span = span, .disc = 2, .ival = 0, .sval = s });
    }
    lexer_advance(lexer);
    if (str_eq(ch, "(")) {
    return (Token)((Token){ .kind = 47, .span = span, .disc = 47, .ival = 0, .sval = "" });
    }
    if (str_eq(ch, ")")) {
    return (Token)((Token){ .kind = 48, .span = span, .disc = 48, .ival = 0, .sval = "" });
    }
    if (str_eq(ch, "{")) {
    return (Token)((Token){ .kind = 49, .span = span, .disc = 49, .ival = 0, .sval = "" });
    }
    if (str_eq(ch, "}")) {
    return (Token)((Token){ .kind = 50, .span = span, .disc = 50, .ival = 0, .sval = "" });
    }
    if (str_eq(ch, "[")) {
    return (Token)((Token){ .kind = 51, .span = span, .disc = 51, .ival = 0, .sval = "" });
    }
    if (str_eq(ch, "]")) {
    return (Token)((Token){ .kind = 52, .span = span, .disc = 52, .ival = 0, .sval = "" });
    }
    if (str_eq(ch, ",")) {
    return (Token)((Token){ .kind = 53, .span = span, .disc = 53, .ival = 0, .sval = "" });
    }
    if (str_eq(ch, ";")) {
    return (Token)((Token){ .kind = 54, .span = span, .disc = 54, .ival = 0, .sval = "" });
    }
    if (str_eq(ch, ".")) {
    if (str_eq(lexer_peek(lexer), ".")) {
    lexer_advance(lexer);
    return (Token)((Token){ .kind = 57, .span = span, .disc = 57, .ival = 0, .sval = "" });
    }
    return (Token)((Token){ .kind = 56, .span = span, .disc = 56, .ival = 0, .sval = "" });
    }
    if (str_eq(ch, ":")) {
    if (str_eq(lexer_peek(lexer), ":")) {
    lexer_advance(lexer);
    return (Token)((Token){ .kind = 60, .span = span, .disc = 60, .ival = 0, .sval = "" });
    }
    return (Token)((Token){ .kind = 55, .span = span, .disc = 55, .ival = 0, .sval = "" });
    }
    if (str_eq(ch, "+")) {
    if (str_eq(lexer_peek(lexer), "=")) {
    lexer_advance(lexer);
    return (Token)((Token){ .kind = 43, .span = span, .disc = 43, .ival = 0, .sval = "" });
    }
    return (Token)((Token){ .kind = 26, .span = span, .disc = 26, .ival = 0, .sval = "" });
    }
    if (str_eq(ch, "-")) {
    if (str_eq(lexer_peek(lexer), ">")) {
    lexer_advance(lexer);
    return (Token)((Token){ .kind = 58, .span = span, .disc = 58, .ival = 0, .sval = "" });
    }
    if (str_eq(lexer_peek(lexer), "=")) {
    lexer_advance(lexer);
    return (Token)((Token){ .kind = 44, .span = span, .disc = 44, .ival = 0, .sval = "" });
    }
    return (Token)((Token){ .kind = 27, .span = span, .disc = 27, .ival = 0, .sval = "" });
    }
    if (str_eq(ch, "*")) {
    if (str_eq(lexer_peek(lexer), "=")) {
    lexer_advance(lexer);
    return (Token)((Token){ .kind = 45, .span = span, .disc = 45, .ival = 0, .sval = "" });
    }
    return (Token)((Token){ .kind = 28, .span = span, .disc = 28, .ival = 0, .sval = "" });
    }
    if (str_eq(ch, "/")) {
    if (str_eq(lexer_peek(lexer), "=")) {
    lexer_advance(lexer);
    return (Token)((Token){ .kind = 46, .span = span, .disc = 46, .ival = 0, .sval = "" });
    }
    return (Token)((Token){ .kind = 29, .span = span, .disc = 29, .ival = 0, .sval = "" });
    }
    if (str_eq(ch, "%")) {
    return (Token)((Token){ .kind = 30, .span = span, .disc = 30, .ival = 0, .sval = "" });
    }
    if (str_eq(ch, "=")) {
    if (str_eq(lexer_peek(lexer), "=")) {
    lexer_advance(lexer);
    return (Token)((Token){ .kind = 31, .span = span, .disc = 31, .ival = 0, .sval = "" });
    }
    if (str_eq(lexer_peek(lexer), ">")) {
    lexer_advance(lexer);
    return (Token)((Token){ .kind = 59, .span = span, .disc = 59, .ival = 0, .sval = "" });
    }
    return (Token)((Token){ .kind = 42, .span = span, .disc = 42, .ival = 0, .sval = "" });
    }
    if (str_eq(ch, "!")) {
    if (str_eq(lexer_peek(lexer), "=")) {
    lexer_advance(lexer);
    return (Token)((Token){ .kind = 32, .span = span, .disc = 32, .ival = 0, .sval = "" });
    }
    return (Token)((Token){ .kind = 39, .span = span, .disc = 39, .ival = 0, .sval = "" });
    }
    if (str_eq(ch, "<")) {
    if (str_eq(lexer_peek(lexer), "=")) {
    lexer_advance(lexer);
    return (Token)((Token){ .kind = 35, .span = span, .disc = 35, .ival = 0, .sval = "" });
    }
    return (Token)((Token){ .kind = 33, .span = span, .disc = 33, .ival = 0, .sval = "" });
    }
    if (str_eq(ch, ">")) {
    if (str_eq(lexer_peek(lexer), "=")) {
    lexer_advance(lexer);
    return (Token)((Token){ .kind = 36, .span = span, .disc = 36, .ival = 0, .sval = "" });
    }
    return (Token)((Token){ .kind = 34, .span = span, .disc = 34, .ival = 0, .sval = "" });
    }
    if (str_eq(ch, "&")) {
    if (str_eq(lexer_peek(lexer), "&")) {
    lexer_advance(lexer);
    return (Token)((Token){ .kind = 37, .span = span, .disc = 37, .ival = 0, .sval = "" });
    }
    return (Token)((Token){ .kind = 40, .span = span, .disc = 40, .ival = 0, .sval = "" });
    }
    if (str_eq(ch, "|")) {
    if (str_eq(lexer_peek(lexer), "|")) {
    lexer_advance(lexer);
    return (Token)((Token){ .kind = 38, .span = span, .disc = 38, .ival = 0, .sval = "" });
    }
    return (Token)((Token){ .kind = 41, .span = span, .disc = 41, .ival = 0, .sval = "" });
    }
...
int64_t parse_postfix(Parser* p) {
    ...
    ((Expr*)Vec_get(p->expr_nodes, (expr_idx - 1)))->kind = "call";
    ...
    ((Expr*)Vec_get(p->expr_nodes, (idx - 1)))->sval = field_name;
    expr_idx = idx;
    0;
    } else {
    break;
...
int64_t parse_stmt(Parser* p) {
    /* Let tok declared=TypeParam { name: "Token" } val_ty=TypeParam { name: "Token" } */
    Token tok = parser_peek(p);
    /* Let disc declared=Base(I64) val_ty=Base(I64) */
    int64_t disc = (tok).disc;
    if ((disc == 5)) {
    parser_advance(p);
    ...
    const char* name = (name_tok).sval;
    /* Let t3 declared=TypeParam { name: "Token" } val_ty=TypeParam { name: "Token" } */
    Token t3 = parser_peek(p);
    /* Let ifv_0 declared=TypeParam { name: "Token" } val_ty=TypeParam { name: "Token" } */
    Token ifv_0 = (Token){0};
    if (((t3).disc == 55)) {
    parser_advance(p);
    ifv_0 = parser_advance(p);
    }
    ifv_0;
    ...
    ((Stmt*)Vec_get(p->stmt_nodes, (idx - 1)))->name = name;
    ...
    if ((disc == 14)) {
    parser_advance(p);
    return (int64_t)add_stmt(p, "break");
    }
    if ((disc == 15)) {
    parser_advance(p);
    return (int64_t)add_stmt(p, "continue");
    }
    if ((disc == 13)) {
    parser_advance(p);
    parser_advance(p);
...
bool is_end_of_block(Token tok) {
    /* Let d declared=Base(I64) val_ty=Base(I64) */
    int64_t d = (tok).disc;
    return (bool)((d == 50) || (d == 61));
}

bool is_end_of_paren(Token tok) {
    /* Let d declared=Base(I64) val_ty=Base(I64) */
    int64_t d = (tok).disc;
    return (bool)((d == 48) || (d == 61));
}

bool is_stmt_end(Token tok) {
    /* Let d declared=Base(I64) val_ty=Base(I64) */
    int64_t d = (tok).disc;
    return (bool)(((d == 54) || (d == 50)) || (d == 61));
}
...
const char* cgen_expr(Program* prog, void* exprs, void* stmts, int64_t idx) {
    ...
    if (str_eq(((Expr*)e)->kind, "ident")) {
    return (const char*)((Expr*)e)->sval;
    }
    if (str_eq(((Expr*)e)->kind, "binary")) {
    ...
    if (str_eq(((Expr*)e)->kind, "ref")) {
    /* Let inner declared=Base(Str) val_ty=Base(Str) */
    const char* inner = cgen_expr(prog, exprs, stmts, ((Expr*)e)->left);
    return (const char*)str_add("&", inner);
    }
    if (str_eq(((Expr*)e)->kind, "deref")) {
    /* Let inner declared=Base(Str) val_ty=Base(Str) */
    const char* inner = cgen_expr(prog, exprs, stmts, ((Expr*)e)->left);
    return (const char*)str_add(str_add("(*", inner), ")");
    }
    if (str_eq(((Expr*)e)->kind, "block")) {
...
const char* cgen_stmt(Program* prog, void* exprs, void* stmts, int64_t idx) {
    ...
    if (str_eq(((Expr*)s)->kind, "expr")) {
    /* Let val declared=Base(Str) val_ty=Base(Str) */
    const char* val = cgen_expr(prog, exprs, stmts, ((Stmt*)s)->expr_idx);
    return (const char*)str_add(val, ";\n");
    }
    if (str_eq(((Expr*)s)->kind, "while")) {
    /* Let cond declared=Base(Str) val_ty=Base(Str) */
    ...
    if (str_eq(((Expr*)s)->kind, "break")) {
    return (const char*)"break;\n";
    }
    if (str_eq(((Expr*)s)->kind, "continue")) {
